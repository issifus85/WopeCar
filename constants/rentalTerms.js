...
export const CHAUFFEUR_TERMS = {
  ...
  clauses: [
    ...
    { title: 'Security Deposit', body: 'A refundable security deposit is required for every booking: 25% of the total rental amount will be held as a deposit, or a flat GHS 500 deposit for rentals under GHS 2,000. This deposit is held against minor issues or unforeseen costs and is fully refunded once the vehicle is returned in good condition and all terms are met.' },
    { title: 'Payment Terms', body: 'Full payment is kindly required before the rental commences. Payments may be made via Mobile Money, Bank Transfer, or Paystack.' },
